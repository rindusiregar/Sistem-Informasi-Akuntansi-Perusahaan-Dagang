                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <form  action="/barang/create"  method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input name="harga_beli" type="number" class="form-control" id="exampleInputHarga_beli1" placeholder="Harga Beli">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputNama1">Harga Jual</label>
                                <input name="harga_jual" type="number" class="form-control" id="exampleInputHarga_jual1" placeholder="Harga Beli">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputNama1">Stok</label>
                                <input name="stok_tersedia" type="number" class="form-control" id="exampleInputStok_tersedia1" placeholder="Jumlah Stok">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputNama1">ID Supplier</label>
                                <input name="id_supplier" type="id" class="form-control" id="exampleInputID_Supplier1" placeholder="ID Supplier">
                            </div>
